"""
Simple standalone seed script for prompt templates
Run this with: conda activate uni-chat && python seed_templates_simple.py
"""
import os
import sys
...
# Templates data (32 professional templates)
TEMPLATES = [
    # Product Photography
